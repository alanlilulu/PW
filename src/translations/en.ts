export const en = {
  ...
  about: {
    ...
    approachDescription1: 'My long-term vision is to combine engineering, design, and creativity — building products that people truly need, while also keeping space for art and storytelling.',
    approachDescription2: 'I create digital experiences and capture human stories — through code, design, and lens.',
