    ...
    <SectionWrapper id="career" background="gray">
      ...
      <Container>
        ...
        <SectionContent direction="up" delay={1.0} distance={100} duration={1.8}>
          ...
          >
            <HoverCard scale={1.05} shadow={false} lift={false}>
              <button
              ...
              >
                {/* 背景渐变 */}
                <div className="absolute inset-0 bg-gradient-to-r from-gray-600 to-gray-700 rounded-full shadow-lg group-hover:shadow-xl transition-all duration-300" />
